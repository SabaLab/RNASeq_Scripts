...
# This version will add chr back to the begining of the chromosome.
##############################################################################################

if [ "$#" -lt 4 ]; then
        echo "Usage: bamToBigWig.Stranded.wChr.sh /path/to/DirWBam bamFileName /path/to/BigWigOutput chromSizesFile"
        echo ""
	...
	echo "bam file. wChr adds chr back at the begining of the bedGraph files before converting"
	echo "to bigWig files. Note: If your chrom.sizes start with chr and intermediate bedGraph "
	echo "files don't you need this version"
	echo ""
